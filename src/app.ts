...
// todo: why this script can't use import???
...
let dropDown = <HTMLSelectElement> document.getElementById("animations")!;
dropDown.addEventListener('change', (evt) => {
    playerState = (evt.target! as HTMLInputElement).value;
...
function animate() {
    ...
    ctx.drawImage(playerImage,
        frameX, frameY, SPRITE_WIDTH, SPRITE_HEIGHT, // frame in sheet
...
function getSpriteObjByName(name: string = 'idle') {
    return spriteObjects.find((value, index, array): sprite.spriteType | null => {
